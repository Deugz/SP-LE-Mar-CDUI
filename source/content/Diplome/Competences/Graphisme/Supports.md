...
- <span id="photoshop-focus2">Utiliser les fonctions et les outils d’un logiciel de traitement d’images matricielles</span>
...
- <span id="Photo-focus2">Cadrer un sujet en photographie sur plusieurs plans</span>
- Utiliser les fonctions et outils de recherches sur le web
- <span id="charte-graphique-focus2">Respecter, décliner une charte graphique</span>
...
### Les consignes du cahier des charges ou du brief créatif sont respectées

### L’enregistrement des ressources utilisées est non-destructif et adapté au résultat attendu

### Le format, le mode colorimétrique et la résolution des fichiers sont adaptés aux supports finaux

### Les textes sont corrects par rapport aux règles typographiques et orthographiques