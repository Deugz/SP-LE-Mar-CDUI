const gameContainer = document.getElementById("CG-game");
let score = 0;
let highScore = 0;
...
function tryAgain() {
  const tryAgainButton = document.getElementById("CG-try-again");
  tryAgainButton.style.display = "block";
  tryAgainButton.innerHTML = `Try Again`;
  tryAgainButton.addEventListener("click", () => {
    generateSquares();
    score = 0;
    const scoreDisplay = document.getElementById("CG-score");
...
function handleWrong() {
  const game = document.getElementById("CG-game");
